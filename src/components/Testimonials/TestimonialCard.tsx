...
export default function TestimonialCard({ testimonial }: Props) {
  return (
    <div className="relative w-full h-auto rounded-[40px] border border-white/[0.06] ring-1 ring-white/[0.08] ring-inset bg-gradient-to-b from-[#0a0a0c]/90 via-[#060608]/95 to-[#020203]/98 backdrop-blur-3xl px-4 sm:px-10 md:px-14 pt-10 sm:pt-12 md:pt-14 pb-12 sm:pb-16 md:pb-20 overflow-hidden shadow-[0_32px_64px_-16px_rgba(0,0,0,0.85),0_0_1px_1px_rgba(255,255,255,0.02)_inset]">

      {/* Glass Diagonal Light Sheen */}
      <div
      ...
      <div className="relative z-10 flex flex-col items-center justify-center gap-6 sm:gap-8 md:gap-10 h-full w-full">
        ...
        <div className="flex flex-col items-center justify-center gap-5 w-full">
          ...
          {/* Name Pill — no negative margin, sits cleanly inside card */}
          <div className="flex items-center gap-3 sm:gap-4 text-left mx-auto w-full max-w-[290px] sm:max-w-xs md:max-w-sm bg-white/[0.04] border border-white/[0.08] p-2.5 sm:p-3 pt-3 pb-3 pr-4 sm:pr-5 rounded-3xl backdrop-blur-sm shadow-xl">
